...
setup(name='wordops-saleh',
      version='3.22.0',
      description='Saleh\'s custom WordOps - An essential toolset that eases server administration',
      ...
      author='Saleh',
      author_email='alnaggar-dve@gmail.com',
      url='https://github.com/alnaggar-dev/WordOps',
      license='MIT',
      project_urls={
          'Documentation': 'https://waashub.com',
          'Forum': 'https://waashub.com/forum',
          'Source': 'https://github.com/alnaggar-dev/WordOps',
          'Tracker': 'https://github.com/alnaggar-dev/WordOps/issues',
      },
